...
export type {webamp_state_set, webamp_state_set_data} from '../events/webamp_state_set.ts';
export type {webamp_state, webamp_state_data} from '../events/webamp_state.ts';
